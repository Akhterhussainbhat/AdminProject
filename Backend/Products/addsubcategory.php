...
//$sql1="SELECT formtable.title as catetitle, subcat.* FROM formtable JOIN subcat ON subcat.catid = formtable.id";
...
$sql="INSERT INTO subcat(catid,title,description, image)VALUES('$CatId','$Title','$Description','$file_destination')";
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<a href='<?php echo viewsub?>'><input type='submit'  class="btn btn-danger" value='Viewsubcategory'></a>
